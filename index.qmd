...
<!-- <a href="https://labs.ala.org.au/lens"> ![](images/homepage/lens-bubble-image.png){.home-img-lens} </a> -->
<!-- ::: -->
...
<!-- ALA <img src="images/logos/lens-logo.svg" class="lens-logo"/></img> Lens -->

<!-- </h1> -->

<!-- </a> -->

<!-- Dive into data using a [new interactive interface](https://labs.ala.org.au/lens) for exploring ALA data. Try out new views of the ALA, designed to encourage exploration and discovery of species, data and place.<br> -->
...
<!-- [Images (all CC-BY-NC): Kai Squires, andrewpavlov, mikegrow, kerrbrad, Matt Campbell, Toby Esplin, darcywhittaker]{style="font-size:.7rem; color:#a7abb4;"} -->
...
<!-- ::::: column-screen-inset -->
<!-- ::: {.home-column-image .col-right} -->
<!-- <a href="https://labs.ala.org.au/research/highlights/"> ![](images/homepage/home_ala-research.png){.home-img} </a> -->
<!-- ::: -->
